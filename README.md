...
## Random vehicle comments

This vehicle has definitely been an interesting learning experience over the years. Despite the C-Max being a sibling of the Focus and Escape and having a lot of C1MCA electrical architecture, the hybrid and plug-in models destined for the North American market appears to have added a healthy mix of CGEA1.2 architecture likely relating to most of the added hybrid architecture. So in this CAN research there's some data that easily translates from the existing CGEA1.2 DBC files provided by Comma AI in their [OpenDBC](https://github.com/commaai/opendbc) repo while other data is C1MCA which, unfortunately, has a lot less public documentation. An interesting tidbit that has been found as part of the 4G TCU upgrade saga on these vehicles is their AsBuilt configuration HAS to be set to CGEA1.2 to fully function. Setting to C1MCA causes some features to be inoperative including the remote control functions. There have also been some AsBuilt configs in the Sync APIM with a similar behavior needing to be set to CGEA1.2.
